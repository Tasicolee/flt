...
class ThemeUtils {
  ...
  static SystemUiOverlayStyle appSystemUiOverlayStyle() {
    return SystemUiOverlayStyle(
      ...
      statusBarIconBrightness:
          Device.isIOS ? Brightness.light : Brightness.dark,
      //状态栏图标颜色
      statusBarBrightness: Device.isIOS ? Brightness.light : Brightness.dark,
      //状态栏亮度
      systemStatusBarContrastEnforced: false,
      //系统状态栏对比度强制
      systemNavigationBarColor: Colours.app_main_bg,
      //导航栏颜色
  ...
  static void setAppSystemBarStyle({bool? isDark}) {
    if (Device.isAndroid) {
