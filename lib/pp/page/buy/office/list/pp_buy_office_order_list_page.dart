...
/// 订单记录-购买-官方
class PpBuyOfficeOrderListPage extends StatefulWidget {
  const PpBuyOfficeOrderListPage({super.key});

  @override
  _GoodsPageState createState() => _GoodsPageState();
}

class _GoodsPageState extends State<PpBuyOfficeOrderListPage>
          ...
          Expanded(
            child: PageView.builder(
                ...
                itemBuilder: (_, int index) =>
                    PpBuyOfficeOrderItemPage(index: index)),
          )
        ],
      ));
