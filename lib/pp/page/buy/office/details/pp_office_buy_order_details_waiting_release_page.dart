...
/// 订单详情-购买-待放行
class PpOfficeBuyOrderDetailsWaitingReleasePage extends StatefulWidget {
  String order_id;

  PpOfficeBuyOrderDetailsWaitingReleasePage(
      {super.key, required this.order_id});

  @override
  _PageState createState() => _PageState(order_id: order_id);
}

class _PageState extends State<PpOfficeBuyOrderDetailsWaitingReleasePage> {
  String order_id;
