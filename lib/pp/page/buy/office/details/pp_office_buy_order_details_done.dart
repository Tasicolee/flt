...
/// 订单详情-购买-已完成
class PpOfficeBuyOrderDetailsDonePage extends StatefulWidget {
  String order_id;

  PpOfficeBuyOrderDetailsDonePage({super.key, required this.order_id});

  @override
  _PageState createState() => _PageState(order_id: order_id);
}

class _PageState extends State<PpOfficeBuyOrderDetailsDonePage> {
  String order_id;
