...
class PpOfficeBuyOrderDetailsPaidPage extends StatefulWidget {
  String order_id;

  PpOfficeBuyOrderDetailsPaidPage({super.key, required this.order_id});

  @override
  _PageState createState() => _PageState(order_id: order_id);
}

class _PageState extends State<PpOfficeBuyOrderDetailsPaidPage> {
  String order_id;
