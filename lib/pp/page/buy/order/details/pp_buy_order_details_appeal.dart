...
/// 订单详情-购买-已申诉
class PpBuyOrderDetailsAppealPage extends StatefulWidget {
  String order_id;

  PpBuyOrderDetailsAppealPage({super.key, required this.order_id});

  @override
  _PageState createState() => _PageState(order_id: order_id);
}

class _PageState extends State<PpBuyOrderDetailsAppealPage> {
  String order_id;
