...
/// 订单详情-购买-已取消
class PpBuyOrderDetailsCancelPage extends StatefulWidget {
  String order_id;

  PpBuyOrderDetailsCancelPage({super.key, required this.order_id});

  @override
  _PageState createState() => _PageState(order_id: order_id);
}

class _PageState extends State<PpBuyOrderDetailsCancelPage> {
  String order_id;
