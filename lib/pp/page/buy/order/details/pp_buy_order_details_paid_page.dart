...
class PpBuyOrderDetailsPaidPage extends StatefulWidget {
  String order_id;

  PpBuyOrderDetailsPaidPage({super.key, required this.order_id});

  @override
  _PageState createState() => _PageState(order_id: order_id);
}

class _PageState extends State<PpBuyOrderDetailsPaidPage> {
  String order_id;
