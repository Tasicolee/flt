...
/// 订单详情-购买-上传存款凭证
class PpBuyOrderDetailsUploadPage extends StatefulWidget {
  String order_id;

  PpBuyOrderDetailsUploadPage({super.key, required this.order_id});

  @override
  _PageState createState() => _PageState(order_id: order_id);
}

class _PageState extends State<PpBuyOrderDetailsUploadPage> {
  String order_id;
