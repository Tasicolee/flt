...
/// 微信绑定
class PpAddWxPage extends StatefulWidget {
  const PpAddWxPage({super.key});

  @override
  _PageState createState() => _PageState();
}

class _PageState extends State<PpAddWxPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colours.app_main_bg,
          centerTitle: true,
          title: const Text('微信绑定', style: TextStyles.txt18color000000),
          elevation: 0,
  ...
  void _upload(String path, int index) {
    ...
    _saveUrl = key;
    debugPrint('状态变化: 当前任务状态path=：$path');
  ...
  Future<void> _save() async {
    ...
    PPHttpClient().post(PpUrlConfig.addInfoWx, data: {
