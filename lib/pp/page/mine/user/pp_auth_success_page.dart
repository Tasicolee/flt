...
/// 身份认证成功
class PpAuthSuccessPage extends StatefulWidget {
  const PpAuthSuccessPage({super.key});

  @override
  _PageState createState() => _PageState();
}

class _PageState extends State<PpAuthSuccessPage> {
  @override
              ...
              GestureDetector(
                ...
                child: Container(
                    ...
                    child: const Row(
                      children: [
                        Expanded(child: Text('')),
                        Text('返回', style: TextStyles.txt17colorFFFFFF),
                        Expanded(child: Text('')),
                      ],
                    )),
              )
