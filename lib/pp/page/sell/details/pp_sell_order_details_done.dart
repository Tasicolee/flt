...
/// 订单详情-购买-已完成
class PpSellOrderDetailsDonePage extends StatefulWidget {
  String order_id;

  PpSellOrderDetailsDonePage({super.key, required this.order_id});

  @override
  _PageState createState() => _PageState(order_id: order_id);
}

class _PageState extends State<PpSellOrderDetailsDonePage> {
  String order_id;
